...
.factory('wmFactory', ['$http', function ($http) {
  ...
  postSchedule: function(eStart, lEnd) {
    console.debug(+eStart/1000);
    console.debug(+lEnd/1000);
    return $http({
      method: 'POST',
	   data: JSON.stringify({type:"SHORT", earliestStart:+eStart/1000, latestEnd:+lEnd/1000}),
	   url: urlSch
    });
  }
  }
